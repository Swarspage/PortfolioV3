  ...
  return (
    <button className="group relative dark:bg-neutral-800 bg-neutral-200 rounded-full p-px overflow-hidden">
      <span className="absolute inset-0 rounded-full overflow-hidden">
        <span className="inset-0 absolute pointer-events-none select-none opacity-0 group-hover:opacity-100 transition-opacity duration-300">
          <span
      ...
      <span
        className="inset-0 absolute pointer-events-none select-none opacity-0 group-hover:opacity-100 transition-opacity duration-300"
        style={{
          animation:
            "2s ease-in-out 0s infinite alternate none running border-glow-translate",
        }}
      >
        <span
          ...
          style={{
            animation:
              "2s ease-in-out 0s infinite alternate none running border-glow-scale",
            background:
              "linear-gradient(135deg, rgb(122, 105, 249), rgb(242, 99, 120), rgb(245, 131, 63))",
          }}
        />
      ...
      <span className="flex items-center justify-center gap-1 relative z-1 dark:bg-neutral-950/90 bg-neutral-50/90 rounded-full py-2 px-4 pl-2 w-full">
        ...
        <span className="bg-linear-to-b ml-1.5 from-blue-200 to-blue-200/50 bg-clip-text text-sm text-transparent group-hover:scale-105 transition transform-gpu">
          {value}
        </span>
      </span>
    </button>
